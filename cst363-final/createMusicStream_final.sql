...
CREATE TABLE RELEASE( 
	...
	CONSTRAINT				RELEASE_ARTIST_ID_FK
	FOREIGN KEY (ARTIST_ID)			REFERENCES ARTIST(ARTIST_ID),
	CONSTRAINT				RELEASE_ALBUM_ID_FK
	FOREIGN KEY (ALBUM_ID)			REFERENCES ALBUM(ALBUM_ID));

CREATE TABLE SONG(
	SONG_ID					CHAR(7)
	CONSTRAINT				SONG_ID_PK PRIMARY KEY,
	SONG_ALBUM_POSITION		SMALLINT		NOT NULL,
	SONG_TITLE				VARCHAR2(35)	NOT NULL,
	SONG_TIME_SEC			NUMBER(4,0)		NOT NULL,
...
CREATE TABLE PLAYLIST_ENTRY(
	...
	CONSTRAINT				PLAYLIST_ENTRY_PLAYLIST_ID_FK
	FOREIGN KEY (PLAYLIST_ID)		REFERENCES PLAYLIST(PLAYLIST_ID),
	CONSTRAINT				PLAYLIST_ENTRY_SONG_ID_FK
...
CREATE TABLE SUBSCRIPTION(
	...
	CONSTRAINT				SUBSCRIPTION_SUBSCRIBER_ID_FK
	FOREIGN KEY (SUBSCRIBER_ID)	REFERENCES SUBSCRIBER(SUBSCRIBER_ID),
	CONSTRAINT					SUBSCRIPTION_PLAYLIST_ID_FK
	FOREIGN KEY (PLAYLIST_ID)	REFERENCES PLAYLIST(PLAYLIST_ID));
