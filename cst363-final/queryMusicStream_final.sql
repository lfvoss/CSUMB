...
set linesize 255
set pagesize 80
select song.SONG_TITLE as "Song Title", album.ALBUM_TITLE as "Album Title", song.SONG_GENRE as "Album Genre" from song join album on song.ALBUM_ID = album.ALBUM_ID where song.SONG_GENRE = 'Rock';
